...
const config={
 items:{title:"الأصناف",endpoint:"/foundation/items",fields:[["code","الكود","text"],["name","الاسم","text"],["baseUnit","الوحدة الأساسية","text"]],columns:[["code","الكود"],["name","الاسم"],["baseUnit","الوحدة"],["status","الحالة"]]},
