...
| Surface | Count |
|---|---:|
| API route declarations | 2 |
| Public HTML pages | 0 |
| Drizzle schema tables | 0 |
| Ordered SQL migrations | 0 |
| Declared roles | 18 |
